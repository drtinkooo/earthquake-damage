...
var format_ImpactedFeilds_1 = new ol.format.GeoJSON();
var features_ImpactedFeilds_1 = format_ImpactedFeilds_1.readFeatures(json_ImpactedFeilds_1, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ImpactedFeilds_1 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ImpactedFeilds_1.addFeatures(features_ImpactedFeilds_1);
var lyr_ImpactedFeilds_1 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ImpactedFeilds_1, 
                style: style_ImpactedFeilds_1,
                popuplayertitle: 'Impacted Feilds',
                interactive: true,
                title: '<img src="styles/legend/ImpactedFeilds_1.png" /> Impacted Feilds'
            });
...
lyr_GoogleMapsRoads_0.setVisible(true);lyr_ImpactedFeilds_1.setVisible(true);lyr_DamagedTransportation_2.setVisible(true);lyr_DamagedBuildings_3.setVisible(true);lyr_DamagedCulturalHeritageSites_4.setVisible(true);
var layersList = [lyr_GoogleMapsRoads_0,lyr_ImpactedFeilds_1,lyr_DamagedTransportation_2,lyr_DamagedBuildings_3,lyr_DamagedCulturalHeritageSites_4];
lyr_ImpactedFeilds_1.set('fieldAliases', {'SensorDate': 'SensorDate', 'Settlement': 'Settlement', 'Notes': 'Notes', 'EventCode': 'EventCode', 'SiteID': 'SiteID', 'SensorID': 'SensorID', 'Confidence': 'Confidence', 'FieldValid': 'FieldValid', 'Main_Dmg': 'Main_Dmg', 'Grouped_Da': 'Grouped_Da', 'StaffID': 'StaffID', 'ImageID_Nu': 'ImageID_Nu', });
...
lyr_ImpactedFeilds_1.set('fieldImages', {'SensorDate': 'DateTime', 'Settlement': 'TextEdit', 'Notes': 'TextEdit', 'EventCode': 'TextEdit', 'SiteID': 'TextEdit', 'SensorID': 'TextEdit', 'Confidence': 'TextEdit', 'FieldValid': 'TextEdit', 'Main_Dmg': 'TextEdit', 'Grouped_Da': 'TextEdit', 'StaffID': 'TextEdit', 'ImageID_Nu': 'TextEdit', });
...
lyr_ImpactedFeilds_1.set('fieldLabels', {'SensorDate': 'no label', 'Settlement': 'no label', 'Notes': 'no label', 'EventCode': 'no label', 'SiteID': 'no label', 'SensorID': 'no label', 'Confidence': 'no label', 'FieldValid': 'no label', 'Main_Dmg': 'no label', 'Grouped_Da': 'no label', 'StaffID': 'no label', 'ImageID_Nu': 'no label', });
